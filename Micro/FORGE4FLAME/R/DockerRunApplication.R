...
docker.f4f.run <- function(){
  ...
  ## to execute docker
  cat(paste("docker run -it --rm -p 3838:3838 qbioturin/f4f-application"))
  system(paste("docker run -it --rm -p 3838:3838 qbioturin/f4f-application") )
